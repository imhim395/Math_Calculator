...
def display_menu():
    ...
    print("\n" + "=" * 60)
    print("   " + " " * 15 + "ADVANCED CALCULATOR" + " " * 15)
    print("   " + " " * 10 + "Enhanced Math Function Calculator" + " " * 10)
    print("=" * 60)
...
def main():
    ...
    print("\n" + "=" * 60)
    print("   Welcome to the Advanced Math Function Calculator!")
    print("=" * 60)
    print("   Features:")
    print("   • Comprehensive mathematical functions")
